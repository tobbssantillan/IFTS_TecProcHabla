...
"""## Análisis de texto Los Viajes de Marco Polo Vol. II"""
...
wordcloud = WordCloud(width=800, height=400, background_color="grey", colormap = "inferno").generate(texto_limpio)
